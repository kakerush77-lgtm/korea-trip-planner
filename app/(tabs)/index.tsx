          ...
          <View style={[styles.section, { backgroundColor: colors.surface, borderColor: colors.border }]}>
            ...
            <View style={styles.actionGrid}>
              ...
              >
                ...
                <Text style={styles.actionCardText}>テキスト共有</Text>
              </Pressable>
              <Pressable
              ...
              >
                ...
                <Text style={styles.actionCardText}>エクスポート</Text>
              </Pressable>
              <Pressable
              ...
              >
                ...
                <Text style={styles.actionCardText}>インポート</Text>
              </Pressable>
              <Pressable
              ...
              >
                ...
                <Text style={styles.actionCardText}>日程管理</Text>
              </Pressable>
            </View>
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  actionCardText: { color: "#fff", fontSize: 13, fontWeight: "700" },
  modalOverlay: {
    flex: 1,
